$(document).ready(function() {
    if ($(".invoice-data-table").length) {
        $(".invoice-data-table").DataTable({
            ...
            language: {
                search: "",
                searchPlaceholder: "Search Referal"
            },
            select: {
                style: "multi",
    ...
    $(".invoice-item-repeater").length && $(".invoice-item-repeater").repeater({
        ...
        e.parents().eq(4).find(".discount-value").html(t + "%"), e.parents().eq(4).find(".tax1").html(i), e.parents().eq(4).find(".tax2").html(n), $(".dropdown-button").dropdown("close")
