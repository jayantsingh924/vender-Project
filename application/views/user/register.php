...
<head>
    ...
    <link rel="shortcut icon" type="<?php echo base_url(); ?>image/x-icon" href="<?php echo base_url(); ?>app-assets/images/favicon/favicon-32x32.png">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>app-assets/css/pages/register.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 register-card bg-opacity-8">
    <form class="login-form" method="post" action="<?php echo base_url(); ?>user/save">
      <div class="row">
        <div class="input-field col s12">
          <h5 class="ml-4">Register USER</h5>
      ...
      <div class="row">
        <div class="input-field col s12">
          <p class="margin medium-small"><a href="<?php echo base_url(); ?>user/login">Already have an account? Login</a></p>
        </div>
      </div>
    </form>
  </div>
