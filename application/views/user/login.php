...
<head>
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
    <form class="login-form" method="post" action="<?php echo base_url(); ?>user/login_check">
      <div class="row">
     ...
     <!--  <div class="row">
      ...
      <div class="row">
        <div class="input-field col s12">
            <button class="btn waves-effect waves-light border-round 
                           gradient-45deg-purple-deep-orange col s12" type="submit">Submit
      ...
      <div class="row">
        <div class="input-field col s6 m6 l6">
          <p class="margin medium-small"><a href="<?php echo base_url(); ?>user/register">Register Now!</a></p>
        </div>
        <div class="input-field col s6 m6 l6">
